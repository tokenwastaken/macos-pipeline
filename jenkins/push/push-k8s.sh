...
kubectl create -f /Users/iskender/Desktop/pipeline/jenkins/push/maven-pod.yml
kubectl create -f /Users/iskender/Desktop/pipeline/jenkins/push/maven-deploy.yml
